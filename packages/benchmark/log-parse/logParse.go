...
func processProducerLogs(fp string) *producerLogSummary {
	recs := make(chan *logRecord)
	go scanLogFile(fp, recs)
...
func (s *producerLogSummary) printSummary() {
	fmt.Println("Producer Log Summary:")
	fmt.Printf("  Total Requests: %d\n", s.totalRequests)
	fmt.Printf("  Total Failed Requests: %d\n", s.totalFailed)
	fmt.Printf("  Total Synchronous Requests: %d\n", s.totalSync)
	fmt.Printf("  Total Dispatched Jobs: %d\n", s.totalRequests-s.totalFailed)
}
